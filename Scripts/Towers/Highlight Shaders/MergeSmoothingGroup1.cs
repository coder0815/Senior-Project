...
public class MergeSmoothingGroup1 : MonoBehaviour
{
	static MergeSmoothingGroup1()
	{
		#if UNITY_EDITOR
	...
	static void Update ()
	{
		MergeSmoothingGroup1[] msgs = Resources.FindObjectsOfTypeAll (typeof(MergeSmoothingGroup1)) as MergeSmoothingGroup1[];

		foreach (MergeSmoothingGroup1 msg in msgs)
		{
			msg.enabled = true;
		}
		#if UNITY_EDITOR
