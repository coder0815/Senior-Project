...
/*SF_DATA;ver:1.26;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:True,rprd:False,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:2,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:9123,x:32987,y:32692,varname:node_9123,prsc:2|diff-4020-OUT,emission-309-OUT,olwid-9071-OUT,olcol-4095-RGB;n:type:ShaderForge.SFN_Tex2d,id:1035,x:32417,y:32095,ptovrint:False,ptlb:Diffuse Map,ptin:_DiffuseMap,varname:node_1035,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:8824,x:32667,y:32225,varname:node_8824,prsc:2|A-1035-RGB,B-9096-RGB;n:type:ShaderForge.SFN_Color,id:9096,x:32417,y:32279,ptovrint:False,ptlb:_Diffuse Color,ptin:__DiffuseColor,varname:node_9096,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Color,id:8717,x:32224,y:32437,ptovrint:False,ptlb:_Highlight Color,ptin:__HighlightColor,varname:node_8717,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Fresnel,id:8198,x:32224,y:32594,varname:node_8198,prsc:2|EXP-534-OUT;n:type:ShaderForge.SFN_Add,id:4020,x:32821,y:32490,varname:node_4020,prsc:2|A-8824-OUT,B-519-OUT;n:type:ShaderForge.SFN_Color,id:4095,x:32765,y:33454,ptovrint:False,ptlb:Outline Color,ptin:_OutlineColor,varname:node_7066,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:0,c3:0,c4:1;n:type:ShaderForge.SFN_Slider,id:6759,x:31942,y:33259,ptovrint:False,ptlb:Outline Width,ptin:_OutlineWidth,varname:node_6759,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.3,max:1;n:type:ShaderForge.SFN_Slider,id:1143,x:31654,y:32813,ptovrint:False,ptlb:Fresnel Strength,ptin:_FresnelStrength,varname:node_1143,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Multiply,id:519,x:32563,y:32513,varname:node_519,prsc:2|A-8717-RGB,B-8198-OUT,C-8198-OUT,D-8198-OUT;n:type:ShaderForge.SFN_Lerp,id:9066,x:32345,y:33151,varname:node_9066,prsc:2|A-5425-OUT,B-129-OUT,T-6759-OUT;n:type:ShaderForge.SFN_Vector1,id:5425,x:32075,y:33059,varname:node_5425,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:129,x:32075,y:33152,varname:node_129,prsc:2,v1:0.05;n:type:ShaderForge.SFN_ConstantLerp,id:534,x:32036,y:32623,varname:node_534,prsc:2,a:1,b:0|IN-1143-OUT;n:type:ShaderForge.SFN_Slider,id:1106,x:32381,y:32830,ptovrint:False,ptlb:Emissive Intensity,ptin:_EmissiveIntensity,varname:_Highlightsurface_copy_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Multiply,id:309,x:32736,y:32771,varname:node_309,prsc:2|A-519-OUT,B-1106-OUT;n:type:ShaderForge.SFN_SwitchProperty,id:9071,x:32538,y:33004,ptovrint:False,ptlb:_Outline On/Off,ptin:__OutlineOnOff,varname:node_9071,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,on:False|A-5425-OUT,B-9066-OUT;proporder:9096-1035-8717-1143-1106-9071-4095-6759;pass:END;sub:END;*/

Shader "Ciconia Studio/Effects/Highlight/Old version(1.0)/Diffuse" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_5425 = 0.0;
                float __OutlineOnOff_var = lerp( node_5425, lerp(node_5425,0.05,_OutlineWidth), __OutlineOnOff );
                o.pos = mul(UNITY_MATRIX_MVP, float4(v.vertex.xyz + v.normal*__OutlineOnOff_var,1) );
